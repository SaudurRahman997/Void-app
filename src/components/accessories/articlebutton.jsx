export default function CustomButton({ href, children }) {
    return (
        <a
            ...
            className="relative inline-block px-6 py-2 font-futura text-white rounded-md group transition-all duration-300 overflow-hidden border border-yellow-100 hover:text-black"
        >
